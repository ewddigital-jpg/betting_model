...
Generated: 2026-03-23T18:30:55.423Z

## Scoreboard
- Trust readiness: 29% / 80% target
- Blind lean accuracy: 52%
- Blind log loss: 0.998
- Settled forward bets: 7
- Historical odds coverage: 8/8544
- Historical lineup coverage: 25/645

## Findings
- [P1] System credibility is still low: Trust readiness is 29% against an 80% target. The app is still in evidence-building mode, not proven mode.
...
- [P1] Latest collector run is not fully clean: The latest collector status is partial. Partial or failed syncs can poison confidence and stale the pre-match view.
  Action: Inspect the latest sync errors first and stabilize data freshness before changing the model logic.
- [P1] Historical odds coverage is still too thin: Only 8 of the last 8544 finished matches have archived bookmaker prices.
...
- [P1] Probability calibration is still loose: Average Brier score across supported markets is about 0.2422. The probabilities still read less sharply than they should.
  Action: Calibrate output probabilities and reduce confidence inflation in unstable bands.
- [P2] Historical lineup archive is incomplete: Only 25 of the last 645 finished matches have stored confirmed lineups.
  Action: Keep backfilling finished fixtures and improve source coverage for missing lineup rows.
- [P2] Forward graded bet sample is still small: Only 7 settled forward bets are graded in the live dashboard.
